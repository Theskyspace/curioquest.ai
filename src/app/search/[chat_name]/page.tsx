...
export default function ChatPage() {
  ...
  return (
    <div>
      <div className="sticky top-2 left-2 z-20 w-full p-2 text-center md:grid grid-cols-12 text-text gap-xl">
        <button
          onClick={() => {
            router.push('/');
          }}
          className="flex items-center justify-center p-2 bg-primary text-white rounded-lg shadow-md hover:bg-primary-dark transition duration-300"
        >
          <svg
            width="24"
            height="24"
